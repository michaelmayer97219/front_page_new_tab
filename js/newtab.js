	...
	$(window).load(function() {
	   ...
	   $addButton.click(function() {
		...
		window.setTimeout(function(){
			if (extraSites.prodMode != true) {
				var numCon = $('.container').size()
				if (numCon == 0 ) {
				$('#main').html("It looks like we haven't detected any sites"+
					"for you automatically. Please use the menu on the right"+
					"and the '+' icon to add sites.")
				}
			}
